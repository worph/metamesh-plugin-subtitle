...
export class WebDAVClient {
    ...
    /**
     * List a directory: GET <dir>/ with Accept: application/json, which both
     * meta-core's WebDAV and meta-sort's nginx autoindex answer with
     * [{name, type: "file"|"directory", size, mtime}].
     *
     * (Addition to the tmdb/still-extractor copy of this file: the subtitle
     * plugin has no /files mount, so sibling discovery must go over WebDAV.)
     */
